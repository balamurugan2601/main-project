        ...
        <Layout>
            <div className="space-y-8">
                <div>
                    ...
                    <p className="text-gray-600 mt-1">Organize teams and communications</p>
                </div>
                    ...
                    {groups.map((group) => (
                        <div key={group._id} className="bg-white p-6 rounded-lg border border-gray-200 shadow-sm flex flex-col h-full">
                            ...
                            <div className="flex-1 mb-6 max-h-48 overflow-y-auto pr-2">
                                <h4 className="text-xs font-bold text-gray-600 mb-3 uppercase tracking-wider">Members</h4>
                                {group.members && group.members.length > 0 ? (
                                    ...
                                    <p className="text-gray-600 text-sm italic py-2">No members assigned yet</p>
                                )}
                            </div>

                            {/* Add Member Form */}
                            <div className="mt-auto pt-4 border-t border-gray-100">
                                <h4 className="text-xs font-bold text-gray-600 mb-2 uppercase tracking-wider">Add Member</h4>
                                <div className="flex gap-2">
                                    <div className="relative flex-1">
                                        <select
                                            aria-label="Select User Context"
                ...
                {groups.length === 0 && !loading && (
                    <div className="text-center py-16 bg-white rounded-lg border border-dashed border-gray-300">
                        <p className="text-gray-600 font-medium">No groups found. Create your first group above.</p>
                    </div>
                )}
            </div>
        </Layout>
